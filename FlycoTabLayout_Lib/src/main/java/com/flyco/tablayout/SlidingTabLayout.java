...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorGradientColors = ta.getResourceId(R.styleable.SlidingTabLayout_tl_indicator_gradient_colors, 0)
                != 0 ? getResources().getIntArray(ta.getResourceId(R.styleable.SlidingTabLayout_tl_indicator_gradient_colors, 0)) : new int[]{};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && mIndicatorGradientColors.length != 0) {
                    mIndicatorDrawable.setOrientation(GradientDrawable.Orientation.LEFT_RIGHT);
                    mIndicatorDrawable.setColors(mIndicatorGradientColors);
                } else

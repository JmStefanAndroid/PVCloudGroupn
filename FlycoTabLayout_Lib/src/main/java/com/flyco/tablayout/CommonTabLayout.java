...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorGradientColors = ta.getResourceId(R.styleable.CommonTabLayout_tl_indicator_gradient_colors, 0)
                != 0 ? getResources().getIntArray(ta.getResourceId(R.styleable.CommonTabLayout_tl_indicator_gradient_colors, 0)) : new int[]{};
